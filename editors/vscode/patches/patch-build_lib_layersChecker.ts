...
@@ -406,7 +406,7 @@ function checkFile(program: ts.Program, sourceFile: ts
...
+	const configHostParser: ts.ParseConfigHost = { fileExists: existsSync, readDirectory: ts.sys.readDirectory, readFile: file => readFileSync(file, 'utf8'), useCaseSensitiveFileNames: (['freebsd', 'linux', 'openbsd'].includes(process.platform)) };
